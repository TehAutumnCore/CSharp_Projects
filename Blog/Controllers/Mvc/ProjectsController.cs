...
public class ProjectsController : Controller
{
    private readonly List<Project> _allProjects = new()
    {
        new Project {
            ...
            Description = "Tech Stack : C#, ASP.NET Core, EF Core, MSSQL, JWT, Razor Views\n Description: Full-stack blog application with separate MVC and REST API layers. Features role-based authentication, session-based JWT, admin-only CRUD, responsive Bootstrap UI, accessibility (WCAG), dark mode, and contact form with secure SMTP email sending.", Link="https://github.com/TehAutumnCore/CSharp_Projects/tree/main/Blog", 
            ImagePath="/images/projects/portfolio.png" },

        new Project {
            Title = "RedZone Getaway", 
            Description = "Tech Stack : Python, JavaScript, React, Django, PostgreSQL\n Description: RedZone Getaway Serves as the ultimate platform for NFL enthusiasts, offering a seamless blend of real-time stats, travel planning, and fan engagement. By Integrating sports and travel, RedZone Getaway delivers an unmatched experience for football fans.", 
            Link="https://github.com/Samue1eun/RedzoneGetaway",
            ImagePath="/images/projects/redzone.jpg" },

            new Project {
            Title = "Game Management", 
            Description = "Tech Stack : Python, JavaScript, React, Django, PostgreSQL\n Description: Solo full-stack project using Twitch and Steam APIs. Offers game discovery, live streams, and CRUD functionality. Features secure token-based authentication and a custom Netflix-style UI for managing game favorites.",
            Link="https://github.com/TehAutumnCore/  Yankee_Platoon_Assignments/tree/main/12-Personal-Project/GameManagementPersonalProject",
            ImagePath="/images/projects/gamemanagement.jpg" },

        new Project {
            Title = "Name of App Here", 
            Description = "App description here", 
            Link="https://github.com/TehAutumnCore/",
            ImagePath="" },///images/projects/projectimg.png
    };
